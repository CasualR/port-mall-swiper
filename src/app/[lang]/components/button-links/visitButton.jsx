...
import styles from "../../scss/button-link/visitButton.module.scss"

const VisitButton = (props) => {
    const buttonLink = props.link;

    console.log(props.customClasses, 'from visit');

    return (
        <>
            <a href={buttonLink} target="_blank" className={`${styles.visit} ${props.customClasses ? props.customClasses.join(' ') : ''}`}>
